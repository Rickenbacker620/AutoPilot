...
void Show_MotorInfo()
{
    printf("Left: Actural: %d\tExpect: %d\t Increment: %d ||| ", Encoder_Left, Target_Left, Motor_Left);
    printf("Right: Actural: %d\tExpect: %d\t Increment: %d\n", Encoder_Right, Target_Right, Motor_Right);
}

void Show_KinematicInfo()
{
